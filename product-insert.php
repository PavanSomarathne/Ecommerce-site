          ...
          <form class="row contact_form" action="" method="post" novalidate="novalidate" id="dynalicKey" enctype="multipart/form-data">
            ...
            if (!empty($product_pkeys)) {
              ...
              do { ?>
                ...
                <div class="col-md-6 form-group p_star">
                  <input type="text" class="form-control" id="email" name="v[]" value="<?php echo $product_pvals[$i] ?>" placeholder="Spec 1">
                </div>
              <?php
                $i++;
              } while (!empty($product_pkeys[$i]));
            } else {
              ?>
              <div class="col-md-6 form-group p_star">
