...
<?php 
	...
	if(isset($_GET['redirect'])){
		if(isset($_GET['prd'])){
			header('Location:http://localhost/aroma/'.$_GET['redirect'].'?prd='.$_GET['prd']);
		}else{
			header('Location:http://localhost/aroma/'.$_GET['redirect']);
		}
    }else{
		header('Location:http://localhost/aroma/index.php');
	}
    }
	}
?>
